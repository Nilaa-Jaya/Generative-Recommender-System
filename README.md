...
1. **Clone the repository**
   ```bash
   git clone https://github.com/Nilaa-Jaya/Generative-Recommender-System.git
   cd Generative-Recommender-System
   ```
...
3. **Download large data files (>2GB)**
   ...
   Three files exceed GitHub's size limit and must be downloaded separately:
...
```bibtex
@software{genrec2025,
  author = {Nilaa Raghunathan},
  title = {GenRec: Generative Retrieval-Augmented Recommender System},
  year = {2025},
  url = {https://github.com/Nilaa-Jaya/Generative-Recommender-System}
}
```
...
**Author**: Nilaa Raghunathan
**GitHub**: [@Nilaa-Jaya](https://github.com/Nilaa-Jaya)
